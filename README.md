El problema es que GitHub a veces aplasta las listas numeradas o los bloques de código cuando no tienen líneas en blanco reales entre ellos.

Aquí tienes el código arreglado en Markdown con viñetas normales (*), saltos de línea dobles bien marcados y sin bloques pegados para que no se amontone nada:
