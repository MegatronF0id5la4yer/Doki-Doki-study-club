...
- Extrae el contenido en tu terminal con: tar -xvf DokiDokiStudyClub-Linux.tar.gz
- Entra a la carpeta: cd nwjs-v0.88.0-linux-x64
- Otorga permisos de ejecución: chmod +x DokiDokiStudyClub
- Lanza el juego: ./DokiDokiStudyClub
...
- En la consola CMD corre: copy /b nw.exe+package.nw DokiDokiStudyClub.exe

### 4. Compilación para Linux (x86_64)
- Empaqueta los assets en Linux: zip -r package.nw index.html ai_services.js img/ music/ package.json
- Descarga y extrae los binarios de NW.js para Linux.
- Fusiona los archivos: cat nw package.nw > DokiDokiStudyClub
- Asigna permisos: chmod +x DokiDokiStudyClub
